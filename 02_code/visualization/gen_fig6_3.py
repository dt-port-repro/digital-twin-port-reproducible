"""Generate Fig 6.4 - Abnormal scenario config comparison
...
for idx, (ax, vals, imps, ylabel, ylim, title) in enumerate([
    (axes[0], turnaround, imp_t, '船舶在港时间 (h)', (15, 18.5), '(a) 船舶在港时间'),
...
plt.savefig(OUT / 'fig6_4_masdes_abnormal.png', dpi=200, bbox_inches='tight', facecolor='white')
plt.savefig(OUT / 'fig6_4_masdes_abnormal.svg', dpi=200, bbox_inches='tight', facecolor='white')
plt.close()
print(f'✅ fig6_4_masdes_abnormal.png')
